...
{
    [Authorize]
    public class AdminProofsController : Controller
    {
        // GET: AdminProof
        ...
        public ActionResult Proof()
        {
            ...
            return View("~/Views/Admin_Mangement/AdminProofs/Proof.cshtml",proofs);
        }
        [HttpGet]
        public ActionResult Create()
        {
            ...
            return PartialView("~/Views/Admin_Mangement/AdminProofs/Create.cshtml", model);
        }
        [HttpPost]
...

        {
            ...
            return PartialView("~/Views/Admin_Mangement/AdminProofs/Proof.cshtml", proof);
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return PartialView("~/Views/Admin_Mangement/AdminProofs/Delete.cshtml", proof_table);
        }

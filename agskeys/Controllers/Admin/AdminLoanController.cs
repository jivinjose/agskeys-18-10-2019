...
namespace agskeys.Controllers.Admin
{
    public class AdminLoanController : Controller
    {
        ...
        public ActionResult Loan()
        {
            ...
            return PartialView("~/Views/Admin_Mangement/AdminLoan/Loan.cshtml", customer_loans);
        }
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            return PartialView("~/Views/Admin_Mangement/AdminLoan/Edit.cshtml", loan_table);
        }

...
namespace agskeys.Controllers.SaleExecutive
{
    ...
    public class SalesExecutiveController : Controller
    {
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            return PartialView("~/Views/SalesExecutive/SalesExecutive/Edit.cshtml", customer_profile_table);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return PartialView("~/Views/SalesExecutive/SalesExecutive/Delete.cshtml", customer_profile_table);
        }

...
{
    public class MobileManagerLoanController : Controller
    {
        ...
        public ActionResult managerloan()
        {
            ...
            return View("~/Views/MobileManager/MobileManagerLoan/managerloan.cshtml", customer_loans);
        }
        ...
        public ActionResult Details(int? Id)
        {
            ...
            return PartialView("~/Views/MobileManager/MobileManagerLoan/Details.cshtml", user);
        }
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            return PartialView("~/Views/MobileManager/MobileManagerLoan/Edit.cshtml", loan_table);
        }
        ...
        public ActionResult Edit(loan_table loan_table)
        {
            if (ModelState.IsValid)
            {
                ...
                ags.SaveChanges();
                //return View("~/Views/MobileManager/MobileManagerLoan/managerloan.cshtml");
                return RedirectToAction("managerloan");
            }
            return PartialView("~/Views/MobileManager/MobileManagerLoan/Edit.cshtml", loan_table);
        }
        ...
        public ActionResult Track(int? Id)
        {
            ...
            return PartialView("~/Views/MobileManager/MobileManagerLoan/Track.cshtml", loan_track);
        }
        public ActionResult Delete(int? Id)
        {
            ...
            return PartialView("~/Views/MobileManager/MobileManagerLoan/Delete.cshtml", user);
        }

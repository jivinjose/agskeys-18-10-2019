...
{    
    [Authorize]
    public class ProcessExecutiveLoanController : Controller
    {
        agsfinancialsEntities ags = new agsfinancialsEntities();
        public ActionResult ProcessExecutiveLoan()
        {
            ...
            return View("~/Views/ProcessExecutive/ProcessExecutiveLoan/ProcessExecutiveLoan.cshtml", customer_loans);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ProcessExecutiveLoan(FormCollection form)
        {
            if (Session["username"] == null || Session["userlevel"].ToString() != "process_executive")
            {
                return this.RedirectToAction("Logout", "Account");
        ...
        public ActionResult Track(int? Id)
        {
            ...
            return PartialView("~/Views/ProcessExecutive/ProcessExecutiveLoan/Track.cshtml", loan_track);
        }
        public ActionResult Delete(int? Id)
        {
            ...
            return PartialView("~/Views/ProcessExecutive/ProcessExecutiveLoan/Delete.cshtml", user);
        }

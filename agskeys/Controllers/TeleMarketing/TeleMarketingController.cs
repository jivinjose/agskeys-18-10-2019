...
namespace agskeys.Controllers.TeleMarketing
{
    ...
    public class TeleMarketingController : Controller
    {
        ...
        public ActionResult Details(int Id)
        {
            ...
            return PartialView("~/Views/TeleMarketing/TeleMarketing/Details.cshtml", user);
        }
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("~/Views/TeleMarketing/TeleMarketing/Create.cshtml", model);
        }
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            return PartialView("~/Views/TeleMarketing/TeleMarketing/Edit.cshtml", customer_profile_table);
        }
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return PartialView("~/Views/TeleMarketing/TeleMarketing/Delete.cshtml", customer_profile_table);
        }
